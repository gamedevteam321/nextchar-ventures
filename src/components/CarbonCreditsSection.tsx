...
const CarbonCreditsSection = () => {
  return (
    <section id="carbon" className="py-6 sm:py-8 md:py-12 bg-white w-full overflow-x-hidden">
      <div className="mx-auto w-full px-4 sm:px-6 md:px-8 lg:pr-[150px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center w-full">
          ...
          <div className="space-y-4 md:space-y-6 w-full">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 md:mb-8 font-montserrat leading-[100%] tracking-[0%] capitalize">
            ...
            <div className="space-y-4 md:space-y-6 w-full">
              <p className="text-sm sm:text-base md:text-lg lg:text-xl font-light font-montserrat leading-[120%] md:leading-[100%] tracking-[0%]" style={{ color: '#474747' }}>
